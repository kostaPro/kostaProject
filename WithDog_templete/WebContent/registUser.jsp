	...
	<div class="wrapper fadeInDown">
		<div id="formContent">
			...
			<form action="registUser.do" method="POST"
				...
				<input type="text" id="userId" class="fadeIn second" name="userId"
					placeholder="ID" > <input type="password" id="password"
					class="fadeIn third" name="password" placeholder="password" > <input
					type="text" id="contact" class="fadeIn second" name="contact"
					placeholder="contact" /> 
				...
				</select> <input type="text" id="petInfo" class="fadeIn second"
					name="petInfo" placeholder="ex) Poodle/3Y/Male dog">

				<section>
					<label class="upload-button">애견 이미지 첨부</label> 
					<input type="file" name="image" id="image" /> 
					
						<img src="#" id="pet_image"
						style="width: 300px; display: absolute; float: center">
				</section>
