		...
		<div class="container">
			<div class="row">
				...
				<section>
					...
					<div class="row">
						<section>
							<h3 align="left">시작일 | ${openDates.stringOpenDate }</h3>
							<h3 align="left">종료일 | ${closeDates.stringCloseDate }</h3>
							<!-- 왜이러시죠 -->
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<div class="post">
												...
												<strong>${comment.writerId}</strong> &nbsp;<span
													class="text-muted">${comment.registDate}</span> <a
													href="${pageContext.request.contextPath}commentModify.do?commentId=${comment.commentId}&eventId=${event.eventId}"
													class="glyphicon glyphicon-cog pull-right"
													style="padding: 10px">수정</a> <a
													href="${pageContext.request.contextPath}commentRemove.do?commentId=${comment.commentId}&eventId=${event.eventId}"
											...
											<div class="write_area">
												<form
													...
													<div>
														...
														<div class="3u">
															<a
																href="registComment.do?eventId=${eventDetail.eventId }"
																class="btn_comm btn_submit form-control"
																style="text-align: center"><strong
																style="color: white">댓글 등록</strong></a>
														</div>
								</c:forEach>
							</c:otherwise>
						</c:choose>
