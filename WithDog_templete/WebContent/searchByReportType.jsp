		...
		<div class="container">
			...
			<div class="container">
				...
				<ul class="nav nav-tabs">
					<li class="active" ><a data-toggle="tab" href="#home">모임</a></li>
					<li><a data-toggle="tab" href="#menu1">장소</a></li>
					<li><a data-toggle="tab" href="#menu2">평가글</a></li>
								...
								<tbody>
									...
									<c:choose>
										...
										<c:otherwise>
											...
											<c:forEach var="commentReport" items="${commentReport }">

												<tr>
													<form action="modifyReport.do">
														<td class="text-center">${commentReport.reportTargetId }</td>
														<td class="text-center">${commentReport.reportContent }</td>

														<td class="text-center"><select name="status"
															id="status">
																<option>${commentReport.status }</option>
														...
														<td><input type="hidden" name="reportType"
															value="comment"> <input type="hidden"
															name="reportTargetId"
															value="${commentReport.reportTargetId }"> <input
															type="submit" value="수정"
															class="btn btn-primary btn-block form-control"
															id="search_btn"
															style="color: #fff !important; background: #43becc; border: 1px solid #43becc !important;">
