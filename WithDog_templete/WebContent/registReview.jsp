					...
					<section>
						...
						<div class="reviews">
							<input class="form-control" id="title" type="text"
								placeholder="제목을 입력해 주세요." name="title" /><br>
							<textarea class="form-control" id="content" rows="10" cols="40"
								placeholder="내용을 입력해 주세요."></textarea><br>
							<div class="row" align="left"><section><input class="btn btn-primary" type="file" id="input_imgs"
								multiple="multiple" />
							<div class="imgs_wrap"></div></section></div>
						</div>
					</section>
				</form>
			</section>
