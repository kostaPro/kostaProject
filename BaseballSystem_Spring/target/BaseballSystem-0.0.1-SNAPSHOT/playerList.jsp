						...
						<tbody>
							<c:choose>
								...
								<c:when test="${teamList ne null }">
									<c:forEach items="${teamList }" var="team" varStatus="teamNo">
										<c:forEach items="${team.players }" var="player"
											...
											<tr>
												...
												<td class="text-center">좌투우타</td>
												<td class="text-center"><a
													href="teamDetail.do?teamId=${team.teamId }">${team.name }</a></td>
												<td class="text-center"><a
													href="trade.do?playerId=${player.playerId }">트레이드</a></td>
											</tr>
										</c:forEach>
									</c:forEach>
								</c:when>
								...
								<c:when test="${team ne null }">
									<c:forEach items="${team.players }" var="player" varStatus="no">
										<tr>
